...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-8543111.622988, 43394.509053, -8140724.253839, 314513.219435], maxZoom: 15, minZoom: 1
    })
});


map.getView().fit([-8543111.622988, 43394.509053, -8140724.253839, 314513.219435], map.getSize());
